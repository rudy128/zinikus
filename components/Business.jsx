    ...
    <>
        ...
        <section id='second-section' ref={secondSectionRef} className={`flex h-auto sm:h-[500px] mx-4 sm:mx-8 lg:mx-60 relative ${isSecondVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
            <div className='space-y-10 ml-0 sm:ml-[5%] flex flex-col relative pb-24'>
                <h1 className={`text-4xl sm:text-7xl font-bold ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.2s]' : ''}`}>
                    ZORO
                </h1>
                <h4 className={`text-[#545454] text-lg sm:text-2xl ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.3s]' : ''}`}>
                    ZORO is an intelligent catering and food delivery robot<br /> designed to revolutionize the way meals are served.<br />Whether in restaurants, hotels, or corporate spaces.
                </h4>
                <Link href='/products/zoro'>
                    <button className={`border border-black px-4 py-3 rounded-3xl text-lg font-bold w-fit ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.4s]' : ''}`}>
                        Learn About Zoro
                    </button>
                </Link>
            </div>
            <Image 
                ...
                width={500} 
                height={720} 
                className={`absolute right-20 z-10 ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.3s]' : ''}`} 
            />
        </section>

        {/* Third Section */}
        <section id='third-section' ref={thirdSectionRef} className={`h-auto sm:h-[1087px] gap-x-10 relative flex justify-start p-10 pb-0 items-center bg-gradient-to-br from-[#27272d] to-85% to-[#8428e0] ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
            <div className='flex flex-col gap-y-40 w-full sm:w-1/2 ml-0 sm:ml-[15%]'>
                <Image 
                    ...
                    width={460} 
                    height={900} 
                    className={`${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`} 
                />
            </div>
            <div className='w-full sm:w-1/2 pl-0 sm:pl-32 mx-auto mr-0 sm:mr-60 self-center text-white space-y-10'>
                <h1 className={`text-4xl sm:text-6xl font-bold ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : ''}`}>
                    ZEPHYR
                </h1>
                <p className={`text-xl sm:text-2xl ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`}>
                ...
                <Link href='/products/zephyr'>
                    <button className={`text-lg font-bold border rounded-full px-4 py-2 my-10 ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.7s]' : ''}`}>
                        Learn About ZEPHYR
                    </button>
                </Link>
            </div>
        ...
        {/* Fourth Section */}
        <section id='fourth-section' ref={fourthSectionRef} className={`flex h-auto sm:h-[600px] mx-4 sm:mx-8 mb-[5%] lg:mx-60 relative ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
            <div className='gap-y-10 pl-0 sm:pl-10 relative flex flex-col py-12 pt-40'>
                <h1 className={`text-4xl sm:text-6xl font-bold ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : ''}`}>
                    ZENO
                </h1>
                <h4 className={`text-lg sm:text-2xl ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`}>
                    A smarter welcome begins with ZENO. Designed to<br />redefine hospitality, ZENO is more than just a robot<br/>it&apos;s an intelligent, interactive guide that enhances<br />guest experiences from the moment they arrive.
                </h4>
                <Link href='/products/zeno'>
                    <button className={`border border-black px-4 py-3 w-fit rounded-3xl font-bold ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.7s]' : ''}`}>
                        Learn About Zeno
                    </button>
                </Link>
            </div>
            <Image 
                ...
                width={520} 
                height={900} 
                className={`absolute right-16 -top-1/4 ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`} 
            />
        </section>
...
const BusinessMobile = () => {
  ...
  return (
    <>
        ...
        {/* Second Section */}
        <section id='second-section' ref={secondSectionRef} className={`flex h-auto mx-4 lg:mx-60 relative ${isSecondVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
            <div className='gap-y-10 ml-0 flex flex-col justify-center items-center relative pb-24'>
                <h1 className={`text-4xl font-bold ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.2s]' : ''}`}>
                    ZORO
                </h1>
                <Image 
                    src={Zoro} 
                    alt='' 
                    className={`right-20 z-10 ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.3s]' : ''}`} 
                />
                <h4 className={`text-[#545454] text-lg sm:px-28 md:px-40 ${isSecondVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.4s_ease-out_forwards] [animation-delay:0.3s]' : ''}`}>
        ...
        {/* Third Section */}
        <section id='third-section' ref={thirdSectionRef} className={`h-auto md:min-h-[1087px] md:py-10 gap-x-10 relative flex justify-start p-10 pb-0 items-center bg-gradient-to-br from-[#27272d] to-85% to-[#8428e0] ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
            {/* <div className='flex flex-col gap-y-40 w-full sm:w-1/2 ml-0 sm:ml-[15%]'>
            </div> */}
            <div className='w-full flex sm:mx-28 flex-col justify-center items-center pl-0 mr-0 self-center text-white space-y-10'>
                <h1 className={`text-4xl font-bold ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : ''}`}>
                    ZEPHYR
                </h1>
                <Image 
                    src={Zephyr} 
                    ...
                    className={`${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`} 
                />
                <p className={`text-xl md:mx-4 ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`}>
                    Your brand deserves a representative that&apos;s smart, efficient, and unforgettable. Meet ZEPHYR, the cutting-edge robot designed to elevate customer interactions with seamless service and precision.
                </p>
                <Link href='/products/zephyr'>
                    <button className={`text-lg font-bold border rounded-full px-4 py-2 my-10 ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.7s]' : ''}`}>
        ...
        {/* Fourth Section */}
        <section id='fourth-section' ref={fourthSectionRef} className={`flex h-auto mx-4 relative ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
            <div className='gap-y-10 pl-0 relative flex flex-col py-12 justify-center items-center'>
                <h1 className={`text-4xl font-bold ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.5s]' : ''}`}>
                    ZENO
                </h1>
                <Image 
                    src={Zeno} 
                    ...
                    // width={520} 
                    // height={900} 
                    className={`right-16 -top-1/4 ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`} 
                />
                <h4 className={`text-lg sm:mx-28 md:mx-40 ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_0.5s_ease-out_forwards] [animation-delay:0.6s]' : ''}`}>
