...
const Business = () => {
  ...
  return (
    <>
        ...
        <section id='third-section' ref={thirdSectionRef} className={`h-auto sm:h-[1087px] gap-x-10 relative flex justify-start p-10 pb-0 items-center bg-gradient-to-br from-[#27272d] to-85% to-[#8428e0] ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_1s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
            ...
            <div className='w-full sm:w-1/2 pl-0 sm:pl-32 mx-auto mr-0 sm:mr-60 self-center text-white space-y-10'>
                ...
                <Link href='/products/zephyr'>
                    <button className={`text-lg font-bold border rounded-full px-4 py-2 my-10 ${isThirdVisible ? 'inline-block opacity-0 animate-[appearFromBelow_1s_ease-out_forwards] [animation-delay:0.7s]' : ''}`}>
                        Learn About ZEPHYR
                    </button>
                </Link>
            </div>
        ...
        {/* Fourth Section */}
        <section id='fourth-section' ref={fourthSectionRef} className={`flex h-auto sm:h-[600px] mx-4 sm:mx-8 mb-[5%] lg:mx-60 relative ${isFourthVisible ? 'inline-block opacity-0 animate-[appearFromBelow_1s_ease-out_forwards] [animation-delay:0.5s]' : 'opacity-0'}`}>
