  ...
  return (
    <nav className='flex justify-between p-4 h-28 items-center'>
        ...
        <div className='flex justify-between w-1/3 font-bold'>
            ...
            <Link className='w-[137.55px] h-[38.02px] bg-gradient-to-r from-black to-[#8428E0] text-white flex justify-center items-center rounded-3xl font-medium' href={'/contact-us'}>
