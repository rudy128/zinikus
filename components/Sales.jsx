...
const Sales = () => {
  return (
    <div className='h-[512px] relative bg-black text-white flex justify-evenly items-center'>
    ...
    return (
        <form action="" className='w-[512px] relative drop-shadow-xl -bottom-[500px] p-8 bg-white text-black flex justify-evenly items-center flex-col'>
            ...
            <div className='w-full mt-16 space-y-8'>
                ...
                <div>
                    <input type="email" placeholder='Business Email*' className='border-b border-black w-full focus:outline-none focus:border-green-500 focus:border-b' />
